...
export declare type RetapDisclosureProps = PropsWithChildren &
  Omit<ModalProps, "isOpen" | "onClose" | "children" | "id"> & {
    id: string;
  };
...
export declare type InitialStateMeta = {
  youtube?: Partial<
    Pick<YoutubeMeta, "alignment" | "width" | "height" | "menuProps">
  >;
  image?: Partial<
    Pick<ImageMeta, "alignment" | "width" | "height" | "menuProps">
  >;
  video?: Partial<
    Pick<VideoMeta, "alignment" | "width" | "height" | "menuProps">
  >;
};
export declare type InitialState = React.Dispatch<
  React.SetStateAction<InitialStateMeta>
>;
