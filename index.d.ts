import { BoxProps, UseDisclosureProps, FlexProps, ModalProps, ButtonProps, SelectProps } from "@chakra-ui/react";
import { Extensions, Editor, BubbleMenuProps } from "@tiptap/react";
import { ReactElement, FC, PropsWithChildren, ButtonHTMLAttributes } from "react";
...
export declare type CustomNodeAttributes = ImageNodeAttibutes | YoutubeNodeAttibutes | VideoNodeAttibutes;
export declare interface NodeMeta<NodeAttributes> {
    ...
    setMenuProps: ReactDispatch<(Omit<RetapToolbarProps, "editor"> & {
        styles?: FlexProps;
    }) | undefined>;
}
